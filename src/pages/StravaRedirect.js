  ...
  componentDidMount() {
    const authenticate = async () => {
      ...
      try {
        ...
        if (_.isEmpty(location)) { return history.push("/"); }
...
const mapStateToProps = (state) => { return { authTokenURL: state.authTokenURL }; };

export default connect(mapStateToProps, { setUserActivities, setUser })(StravaRedirect);
